...
class MadeWithSionna(SphinxDirective):
    ...
    def run(self):
        ...
        html_str = (
            ...
            f'<div style="margin-top:2; margin-bottom:10px; text-align:left;">'
            f'<table style="margin-left:0; margin-right:auto; text-align:left;"><tr>'
        )
        ...
        if link_arxiv is not None:
            html_str += (
                ...
                f'<img alt="arXiv" src="_static/arxiv_logo.png" '
                f'class="arxiv-logo" '
                f'style="width: 24px; min-width: 24px"></a>'
        ...
        if link_pdf is not None:
            html_str += (
                f'<td style="padding: 0 0 0 {0 if is_first_link else 30}px;">'
                f'<a href="{link_pdf}" style="vertical-align:text-top">'
                f'<i class="fa-solid fa-file-lines" style="font-size:19px;"></i>'
                f'</a></td>'
        ...
        if link_github is not None:
            html_str += (
                ...
                f'<i class="fa-brands fa-github" style="font-size:24px;"></i>'
                f'</a></td>'
                f'<td style="padding: 4px;">'
                f'<a href="{link_github}" style="vertical-align:text-bottom">'
        ...
        if link_code is not None:
            html_str += (
                ...
                f'<i class="fa-solid fa-code" style="font-size:24px;"></i>'
                f'</a></td>'
                f'<td style="padding: 4px;">'
                f'<a href="{link_code}" style="vertical-align:text-bottom">'
                f'View Code</a></td>'
        ...
        html_str += f'</tr></table></div><p>{abstract}</p></embed>'
